...
scenario "add a new conference with some optional fields", {
    ...
    then 'new conference is in the system', {
        io.getPrintouts().shouldHave("Conference{citationKey=newKey, author=author, title=title, bookTitle=bookTitle, year=2016, editor=editor, organization=organization, publisher=publisher, note=note, key=key}")
